      ...
      <div className="container mx-auto h-full w-full space-y-8">
        ...
        >
          <p className="text-lg font-light leading-relaxed text-zinc-800 dark:text-zinc-300 lg:text-xl">
            ...
            <span className="font-medium text-foreground">PHP</span> and later
            ...
            <span className="font-medium text-foreground">MySQL</span> as the
          ...
          <p className="text-lg font-light leading-relaxed text-zinc-800 dark:text-zinc-300 lg:text-xl">
            ...
            <a
              ...
              rel="noopener noreferrer"
              target="_blank"
              className="text-nowrap font-medium text-foreground underline transition-colors hover:text-primary"
            >
              JavaScript course
            </a>{" "}
          ...
          <p className="text-lg font-light leading-relaxed text-zinc-800 dark:text-zinc-300 lg:text-xl">
            While learning the afromentioned technologies, I found myself drawn
            to <span className="font-medium text-foreground">back-end</span>{" "}
            side of things as well, exploring back-end technologies like{" "}
            <span className="font-medium text-foreground">Node.js</span> with{" "}
            ...
            <span className="font-medium text-foreground">MongoDB</span>. Each
