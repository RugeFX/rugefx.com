  ...
  return (
    ...
    >
      <div className="relative flex flex-col items-center text-center lg:items-start lg:text-left">
        ...
        >
          A primarily self-taught{" "}
          <span className="text-foreground font-semibold">
            Full-Stack Developer
          </span>{" "}
          building web, mobile, and connected operational systems with modern
          technologies.
        </motion.p>
        <motion.div
        ...
        >
          ...
          >
            ...
            <span className="from-primary to-primary absolute inset-0 -z-10 bg-linear-to-br via-purple-600 opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
          </motion.a>
        ...
        >
          <motion.a
            className="group bg-accent hover:bg-primary hover:text-primary-foreground rounded-full p-3 transition-colors"
